...
def eval_fn(preds, labels, adjust):
  ...
  """
  if not(preds.shape[0]== 1 or preds.shape[1]== 1): 
...
def run_inference(graph_func,
  ...
  os.system('tegrastats --interval 15 --logfile gpu_logs/'+ args.log_name + ' &')
...
if __name__ == '__main__':
  ...
  parser.add_argument('--target_duration', type=int, default=None,
                      ...
                      'number of seconds.')
  parser.add_argument('--log_name', type=str, default='tegra.log',
                      help='Name of the log tegrastats writes to.')
